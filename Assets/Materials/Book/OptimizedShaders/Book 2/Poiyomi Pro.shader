Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/227c995b4b774944392ee4cd1d0b40f1"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.0.47</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float lineWidth = (10.0 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(0,0.4431373,0.1216102,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
				half3 detailTexture = 0.21763764082 * poiThemeColor(poiMods, float4(0,0.4431373,0.1216102,1), (0.0 /*_DetailTintThemeIndex*/));
				#endif
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				firstShadeMap.rgb *= float4(0.5188679,0.5188679,0.5188679,1).rgb; //* lighColor
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				else if ((3.0 /*_LightingAdditiveType*/) == 1)
				{
